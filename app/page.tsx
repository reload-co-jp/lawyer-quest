...
const Page: FC = () => {
  ...
  return (
    <>
      ...
      >
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "3.5rem 3rem" }}>
        <span
          style={{
        ...
        <p style={{ fontSize: "1.125rem", color: "var(--text-2)", marginBottom: "2.5rem", lineHeight: 1.7, maxWidth: "640px" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <p style={{ fontSize: ".6875rem", color: "var(--text-3)", fontWeight: 600, letterSpacing: ".06em", textTransform: "uppercase", marginBottom: ".75rem" }}>
          演習
        </p>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: ".75rem" }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: ".8125rem", color: "var(--text-2)" }}>条文の読み方・法律用語をやさしく解説</p>
              </div>
            </div>
            <span style={{ color: "var(--text-3)", fontSize: ".875rem" }}>→</span>
          </Link>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: ".75rem" }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: ".8125rem", color: "var(--text-2)" }}>勉強する範囲・意義・難易度を解説</p>
              </div>
            </div>
            <span style={{ color: "var(--text-3)", fontSize: ".875rem" }}>→</span>
          </Link>
